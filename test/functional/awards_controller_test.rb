...
class AwardsControllerTest < ActionController::TestCase
  ...
  test "should create award" do
    assert_difference('Award.count') do
      post :create, award: { description: @award.description, group_id: @award.group_id, pi_id: @award.pi_id, slug: @award.slug, title: @award.title }
    end
  ...
  test "should update award" do
    put :update, id: @award, award: { description: @award.description, group_id: @award.group_id, pi_id: @award.pi_id, slug: @award.slug, title: @award.title }
    assert_redirected_to award_path(assigns(:award))
  end
