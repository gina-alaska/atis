...
set :scm,             :git
set :repository,      "git@github.com:gina-alaska/atis.git"
set :branch,          "origin/develop"
set :migrate_target,  :current
set :ssh_options,     { :forward_agent => true }
set :rails_env,       "production"
set :deploy_to,       "/home/webdev/atis"
...
role :web,    "webdev@atis.x.gina.alaska.edu"
role :app,    "webdev@atis.x.gina.alaska.edu"
role :db,     "webdev@atis.x.gina.alaska.edu", :primary => true
...
namespace :deploy do
  ...
  task :finalize_update, :except => { :no_release => true } do
    ...
    run <<-CMD
      ...
      ln -sf #{shared_path}/unicorn.rb #{latest_release}/unicorn.rb
    CMD
  ...
  task :start, :except => { :no_release => true } do
    run "cd #{current_path} ; bundle exec unicorn_rails -c #{latest_release}/unicorn.rb -D"
  end
